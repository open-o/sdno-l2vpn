 ...
 */
public enum ShareModeType implements ModelEnum {
    L3VPN("delegate"), L2VPN("1:1"), OTHER("N:1");
     ...
     * @since SDNO 0.5
     */
    private ShareModeType(String alias) {
        this.alias = alias;
    }
     ...
     */
    @JsonCreator
    public static ShareModeType fromName(String name) {
        return EnumUtil.valueOf(ShareModeType.class, name);
    }
}
