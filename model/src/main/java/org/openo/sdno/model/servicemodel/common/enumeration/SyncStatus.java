...
/**
 * The enumeration class of Sync status.<br>
 *
 * @author
 * @version SDNO 0.5 2016-6-6
 */
public enum SyncStatus implements ModelEnum {
    SYNC("sync"), OUTSYNC("out-sync");
     ...
     * @since SDNO 0.5
     */
    private SyncStatus(String alias) {
        this.alias = alias;
    }
    ...
    public static SyncStatus fromName(String name) {
        return EnumUtil.valueOf(SyncStatus.class, name);
    }
}
