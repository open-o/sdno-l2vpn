...
/**
 * The enumeration class of PW VLAN action type.<br>
 *
 * @author
 * @version SDNO 0.5 2016-6-6
 */
public enum PwVlanActionType implements ModelEnum {
     ...
     * @since SDNO 0.5
     */
    private PwVlanActionType(String alias) {
        this.alias = alias;
    }
     ...
     */
    @JsonCreator
    public static PwVlanActionType fromName(String name) {
        return EnumUtil.valueOf(PwVlanActionType.class, name);
    }
}
