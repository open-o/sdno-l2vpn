...
/**
 * The enumeration class of service type.<br>
 *
 * @author
 * @version SDNO 0.5 2016-6-6
 */
public enum ServiceType implements ModelEnum {
    L3VPN("l3vpn"), L2VPN("l2vpn"), OTHER("other");
     ...
     * @since SDNO 0.5
     */
    private ServiceType(String alias) {
        this.alias = alias;
    }
    ...
    public static ServiceType fromName(String name) {
        return EnumUtil.valueOf(ServiceType.class, name);
    }
}
