 ...
 */
public enum TpType implements ModelEnum {
    PTP("PTP"), CTP("CTP"), TRUNK("TRUNK"), LOOPBACK("LoopBack"), TP_POOL("TPPool"), NOP("nop");
     ...
     */
    @JsonCreator
    public static TpType fromName(String name) {
        return EnumUtil.valueOf(TpType.class, name);
    }
}
