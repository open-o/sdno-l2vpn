...
/**
 * The enumeration class of Boolean Type.<br>
 *
 * @author
 * @version SDNO 0.5 August 9, 2016
 */
public enum BooleanType implements ModelEnum {
     ...
     * @since SDNO 0.5
     */
    private BooleanType(String alias) {
        this.alias = alias;
    }
    ...
    public static BooleanType fromName(String name) {
        return EnumUtil.valueOf(BooleanType.class, name);
    }
}
